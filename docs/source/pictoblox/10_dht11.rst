...
Dans ce projet, nous allons afficher la température et l'humidité du DHT11 en utilisant le Moniteur Série en :ref:`Upload Mode`.
...
- Utiliser le Moniteur Série en :ref:`Upload Mode`
